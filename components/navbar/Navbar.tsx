  ...
  return (
    <header className="sticky top-0 z-30 w-full px-3 py-3 md:px-6">
      <div className=" mx-auto w-full max-w-[1232px] px-4 md:px-0">
        <div
          className="relative flex w-full items-center justify-between gap-4 rounded-full bg-white/60 backdrop-blur-lg px-5 py-4 shadow-sm lg:justify-start md:px-6 md:py-3"
        >
          <Logo data={data.logo} />
